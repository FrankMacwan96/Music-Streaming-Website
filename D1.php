...
<div><img src="images/mslogo.gif" width="150" height="75" alt="logo" style="box-shadow: 1px 2px 4px rgba(0, 0, 0, .5);background-color:white;">
<?php
      session_start(); 
   ...
   $m=mysql_select_db("1418bece30030",$c);
	 ?>
<input type="button" class="btn" value="SignIn" onclick="window.location.href='signup.php'">
...
<a class="a" href="5.php" >1. The Animal</a>
