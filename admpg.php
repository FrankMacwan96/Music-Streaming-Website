...
<table border='1' id="u" style="cursor:text;">
  ...
  {     
       echo "<tr><td> " .$i. " </td><td> " .$res['full name']. " </td><td> " .$res['mobile']. " </td><td> " .$res['email']. " </td><td> " .$res['password']. " </td><td><input type='button' name='butn' value='Add' class='btn' onclick='Add();'> </td></tr> ";
	   $i=$i+1;
  }
  ?>
   </table>
