...
<?php
   ...
   $m=mysql_select_db("1418bece30030",$c);
	 ?>
<input type="button" class="btn" value="Login" onclick="window.location.href='signup.php">
...
<img src="images/tdf.jpg" width="200" height="200" alt="logo" style="box-shadow: 1px 2px 4px black;float:left">
...
<p>Artist : Bullet For My valentine</p>
<p>Album:The poison</p>
<p>Release: 2005</p>
<audio controls style="margin-top:3cm;width:50%;margin-left:4cm;">
<source src="songs/TDF.ogg" type="audio/ogg">
<source src="songs/TDF.mp3" type="audio/mpeg">
</audio>
<p align="center" style="font-size:30px;background-color:#1E90FF;color:white;">Tears don't fall</p>
</div>
</form>
</body>
</html>