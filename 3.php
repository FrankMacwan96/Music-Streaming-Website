...
<img src="images/hob.jpg" width="200" height="200" alt="logo" style="box-shadow: 1px 2px 4px black;float:left;">
...
<p>Album:Hand of Blood</p>
<p>Release: 2005</p>
<audio controls style="margin-top:3cm;width:50%;margin-left:4cm;">
<source src="songs/HOFB.ogg" type="audio/ogg">
<source src="songs/HOFB.mp3" type="audio/mpeg">
</audio>
<p align="center" style="font-size:30px;background-color:#1E90FF;color:white;">Hand of Blood</p>
</div>
