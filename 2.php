...
<img src="images/awf.jpg" width="200" height="200" alt="logo" style="box-shadow: 1px 2px 4px black;float:left">
...
<p>Album: None(single)</p>
<p>Release: 2015</p>
<audio controls style="margin-top:3cm;width:50%;margin-left:4cm;color:blue;">
<source src="songs/Faded.ogg" type="audio/ogg">
<source src="songs/Faded.mp3" type="audio/mpeg">
</audio>
<p align="center" style="font-size:30px;background-color:#1E90FF;color:white;">Faded</p>
</div>
</form>
</body>
</html>